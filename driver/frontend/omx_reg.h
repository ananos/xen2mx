...
enum omx_user_region_segment_status {
	OMX_USER_SEGMENT_STATUS_GRANTING,
	OMX_USER_SEGMENT_STATUS_GRANTED,
	OMX_USER_SEGMENT_STATUS_UNGRANTING,
	OMX_USER_SEGMENT_STATUS_UNGRANTED,
	OMX_USER_SEGMENT_STATUS_FAILED,
};
enum omx_user_region_status {
	...
	OMX_USER_REGION_STATUS_REGISTERING,
	OMX_USER_REGION_STATUS_REGISTERED,
	OMX_USER_REGION_STATUS_DEREGISTERING,
...
struct omx_user_region {
	...
	struct kref xen_refcount;
	struct omx_endpoint *endpoint;

	struct rcu_head rcu_head; /* rcu deferred releasing callback */
	struct rcu_head xen_rcu_head; /* rcu deferred releasing callback */
	...
	struct omx_user_region_segment {
		...
		uint8_t nr_parts;
		uint32_t all_gref[OMX_XEN_GRANT_PAGES_MAX];
		uint32_t *gref_list;
