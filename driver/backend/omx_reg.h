...
struct omx_user_region_offset_cache {
	...
	struct omx_xen_user_region_segment *xseg;
...
extern int omx_user_region_fill_pages(const struct omx_user_region * region, const struct omx_xen_user_region * xregion, unsigned long region_offset, const struct sk_buff * skb, unsigned long length);
