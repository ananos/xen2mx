...
extern int omx_prepare_notify_unexp_event(struct omx_endpoint *endpoint, char ** recvq_slot);
extern void omx_commit_notify_unexp_event(struct omx_endpoint *endpoint, uint8_t type, void *event, int length);
